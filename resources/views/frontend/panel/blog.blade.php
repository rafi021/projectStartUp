    ...
    <div class="container">
        ...
        <div class="blog-slider row">
            ...
            <div class="col">
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{ asset('frontend_assets') }}/images/blog/blog-1.jpg" alt=""></a>
                    </div>
                    <div class="content">
            ...
            <div class="col">
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{ asset('frontend_assets') }}/images/blog/blog-2.jpg" alt=""></a>
                    </div>
                    <div class="content">
            ...
            <div class="col">
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{ asset('frontend_assets') }}/images/blog/blog-3.jpg" alt=""></a>
                    </div>
                    <div class="content">
