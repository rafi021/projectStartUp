        ...
        <div class="job-list-wrap">
            ...
            <a href="job-single.html" class="job-list">
                <div class="company-logo col-auto">
                    <img :src="`/frontend_assets/images/companies/company-1.png`" alt="Company Logo">
                </div>
            ...
            <a href="job-single.html" class="job-list">
                <div class="company-logo col-auto">
                   <img :src="`/frontend_assets/images/companies/company-2.png`" alt="Company Logo">
                </div>
                <div class="salary-type col-auto order-sm-3">
            ...
            <a href="job-single.html" class="job-list">
                <div class="company-logo col-auto">
                    <img :src="`/frontend_assets/images/companies/company-3.png`" alt="Company Logo">
                </div>
                <div class="salary-type col-auto order-sm-3">
                    <span class="salary-range">$5000 - $8000</span>
            ...
            <a href="job-single.html" class="job-list">
                <div class="company-logo col-auto">
                    <img :src="`/frontend_assets/images/companies/company-4.png`" alt="Company Logo">
                </div>
                <div class="salary-type col-auto order-sm-3">
                    <span class="salary-range">$7000 - $13000</span>
                    <span class="badge badge-success">Full Time</span>
