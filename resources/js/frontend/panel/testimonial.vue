<template>
<div class="section section-padding bg-parallax" :data-bg-image="`/frontend_assets/images/bg/bg-2.jpg`" data-overlay="65">
    <div class="container">
        ...
        <div class="testimonial-slider row">
            ...
            <div class="col">
                <div class="testimonial text-center text-white">
                    ...
                    <img :src="`/frontend_assets/images/authors/author-1.jpg`" alt="">
            ...
            <div class="col">
                <div class="testimonial text-center text-white">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, modi sed praesentium necessitatibus tenetur neque, veritatis esse voluptatem</p>
                    <img :src="`/frontend_assets/images/authors/author-2.jpg`" alt="">
            ...
            <div class="col">
                <div class="testimonial text-center text-white">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, modi sed praesentium necessitatibus tenetur neque, veritatis esse voluptatem</p>
                    <img :src="`/frontend_assets/images/authors/author-3.jpg`" alt="">
